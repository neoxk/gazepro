...
export const Home = ({ onContinue, onOpenFolder }: HomeProps): JSX.Element => {
  ...
  const handleFolderSelect = async () => {
    ...
    if (result) setFolderSelected(true)
  }
  ...
  return (
    <>
      ...
      <div
        ...
        style={{ height: '90vh', paddingTop: '12vh', overflow: 'hidden' }}
      >
        <div
        ...
        >
          ...
          <h6 className="fw-normal">
            Train the <span className="text-red-damask">Mind.</span> Sharpen the{' '}
            <span className="text-red-damask">Reflex.</span>
          </h6>
